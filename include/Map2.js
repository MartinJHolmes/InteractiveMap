...
export class Map {
    constructor() {
        ...
        this.mapDefinition = new MapDefinition(coordinate,coordinate,0,0);
    }


    getCoordinate(x,y) {
        let coordinate = new Coordinate(0,0);
        coordinate.lng = ((this.mapDefinition.bottomRight.lng - this.mapDefinition.topLeft.lng) * (x / this.mapDefinition.width)) + this.mapDefinition.topLeft.lng ;
        console.log(`x: ${x}, y: ${y}`);
        console.log(`${this.mapDefinition.topLeft.lng}  ${this.mapDefinition.bottomRight.lng}  ${this.mapDefinition.width}`)
    ...
    loadLocations(mapId) {
        ...
        const mapLocation = new MapDefinition(topLeft, bottomRight, width, height);
        this.mapDefinition = mapLocation;
